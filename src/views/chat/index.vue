        ...
        <div class="row">
            <div class="col-12 col-md-7 col-lg-8 order-2 order-md-2">
              ...
              <div v-show="showAlert" class="alert alert-info">
                کاربر گرامی،
                <br>
                شما می‌توانید از طریق مراجعه به پروفایل افراد، برای آن‌ها پیام خصوصی ارسال کنید و برای ادامه‌ی مکالمه به این صفحه بازگردید. (از نوار جستجوی بالا می‌توانید فرد مورد نظر خود را پیدا کنید.)
            </div>
